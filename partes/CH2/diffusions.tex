...
In Figure \ref{fig:dyson_comparison}, we can see the path of a nine-dimensional Dyson Brownian motion compared to the finite-variation term. 

\begin{figure}[h!] \label{fig:dyson_comparison}
    \input{img/dyson_comparison.pgf}
    \caption{Superposition of simulation of a Dyson Brownian motion and its finite-variation part.}
\end{figure}

\begin{figure}[h!] \label{fig:four_dyson}
    \input{img/four_dysons.pgf}
    \caption{Simulation of four different Dyson Brownian motions with different dimension.}
\end{figure}


\begin{figure} \label{fig:wishart_comparison}
    \input{img/wishart_comparison.pgf}
    \caption{Superposition of path simulations of a Wishart process and its finite dimensional part.}
\end{figure}

\begin{figure} \label{fig:jacobi}
    \includegraphics[width=6in]{img/jacobi.pdf}
    \caption{Psth simulation for a Jacobi process.}
\end{figure}